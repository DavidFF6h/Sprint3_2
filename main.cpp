...
int main() {
    ...
    Game* game = nullptr;  // Pointer to the base class
    game = new SimpleGame(3);  // Initialize with SimpleGame
    ...
    while (!glfwWindowShouldClose(mainWindow)) {
        ...
        guiManager.renderGUI(currentPlayer, selected_radio1, selected_radio2, newGameTriggered, dummyBoardSize, dummyGameMode, newGameMode, *game);
